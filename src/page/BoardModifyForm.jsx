...
// BoardWriteForm 컴포넌트는 Board컴포넌트에서 수정 버튼을 클릭했을 때,
// 1) id값을 가져와서 boardlist의 객체값을 수정해서 작성하는 공간
// 2) 객체를 가져와서 boardlist의 객체값을 수정해서 작성하는 공간 >> 2로 진행
...
export default function BoardModifyForm() {
  ...
  // 글 수정 메소드
    const modifyBoard = () => {
        ...
        // boardData의 모든 속성값을 가져오기 위해,
        const newBoard = {
            ...boardData,
            title, // title : title
            content
        }
        // 2. 배열을 들고 와서 동일한 id에 객체를 바꿔서 새로운 배열 생성
